...
32. Phase 4F runtime profile-control tranche implemented:
   - phase design documented in `docs/plans/2026-02-14-phase4f-profile-control-design.md`,
   - memory core now exposes runtime profile get/set policy operations with strict profile validation,
